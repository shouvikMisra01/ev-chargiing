...
class _$BookingModelImpl extends _BookingModel {
  ...
  @override
  String toString() {
    return 'BookingModel(id: $id, userId: $userId, providerId: $providerId, providerName: $providerName, providerLocation: $providerLocation, portType: $portType, startTime: $startTime, endTime: $endTime, pricePerHour: $pricePerHour, totalAmount: $totalAmount, status: $status, cancellationReason: $cancellationReason, createdAt: $createdAt, confirmedAt: $confirmedAt, cancelledAt: $cancelledAt)';
  }
...
abstract class _BookingModel extends BookingModel {
  const factory _BookingModel(
      ...
      required final String portType,
      ...
      final DateTime? createdAt,
      final DateTime? confirmedAt,
      final DateTime? cancelledAt}) = _$BookingModelImpl;
